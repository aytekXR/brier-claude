...
# E1 stubs are implemented and have dropped out; these are the remaining E2-E4 stubs.
...
# E4-T2 probes (base_rates.base_rate, CoinGeckoPriceSource.daily_closes) implemented
#   and removed — both now return results (0.5 fallback or real rate), not NotImplementedError.
